...
//one controller
myapp.controller("createNewBottleCtrl",
	   ...
	   /* This function will call For Determining value Whether you select the Value (IsSelected)*/
	    ...
	    /* This function will call to initialize the select the Value and return the value*/
		    ...
		    $scope.saveNewBottle = function($event,$scope,item) {
		    	...
		    	var buttonActionName=$event;
		    	var inputValue $scope;
		    	  if($scope == undefined){
		    		//  $scope.create.msg="Please check all the input value";
		    	    }
				  else{
					  var input = $scope;
					  if(buttonActionName ==='newbottleform'){
						  saveBottleValidations(input);
					  }
					  else if(buttonActionName ==='simpleformlogout'){
						  simplelogoutValidations(input);
					  }
					  
						 if(selectedvalue === 'Save' && inputValue){
							$scope.buttonActionName ==buttonActionName; 
							inputValue = $scope
		    	  ...
		    	  $scope.saveBottleValidations = function(input){
		    	  ...
		    	  $scope.simplelogoutValidations = function(input){
